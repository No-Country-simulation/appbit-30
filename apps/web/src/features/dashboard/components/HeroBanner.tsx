    ...
    <section className='relative overflow-hidden rounded-[var(--radius-lg)] bg-[#1a1a2e] p-6 text-white sm:p-8'>
      ...
      <div className='relative z-10'>
        ...
        <p className='mt-2 max-w-xl text-sm text-white/80'>
          Estás a <strong className='text-white'>{cursosPendientes} cursos</strong> de desbloquear{' '}
          <strong className='text-white'>{vacantesDisponibles} vacantes</strong> compatibles en tu zona.
        </p>
